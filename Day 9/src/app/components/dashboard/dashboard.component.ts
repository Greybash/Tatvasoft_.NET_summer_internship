          ...
          <tbody>
            <tr *ngFor="let user of filteredUsers" [class.selected]="selectedUser?.id === user.id">
              ...
              <td class="action-cell">
                <button (click)="editUser(user)" class="edit-btn action-btn" title="Edit" style="color: #667eea;">
                  EDIT
                </button>
                <button (click)="deleteUser(user)" class="action-btn delete-btn" title="Delete" style="color: #e74c3c;">
                  DELETE
                </button>
...
app-navbar {
  flex-shrink: 0;
  width: 250px; /* or your actual sidebar width */
  z-index: 1;
}
